import { classDefinition } from "../../../aria/core/class-definition.js";
import { ModuleCtrl } from "../../../aria/templates/ModuleCtrl.js";
import { ITodoCtrl } from "./ITodoCtrl.js";

export const TodoCtrl = classDefinition({
    $classpath: "ariadoc.guides.todo.TodoCtrl",
    $extends: ModuleCtrl,
    $implements: [ITodoCtrl],
