...
// import { ClassMgr as ariaCoreClassMgr } from "../core/ClassMgr.js"; TODO: ModernAria: Uncomment when class is ready

// ------------------------------------------------
// NOT_IMPLEMENTABLE: ModernAria: Not possible to unload modules + failing dependencies should not happen with ModernAria
...
export const TemplateManager = classDefinition({
    ...
    $prototype : {
        ...
        unloadTemplate : function (classpath, timestampNextTime, stopAtClasspath) {
            // MUST_FIX: ModernAria: Check and implement this method
            ...
            //             if (Object.prototype.hasOwnProperty.call(resources, res) && !Object.prototype.hasOwnProperty.call(curRes, "provider")) {
            ...
            //     // -----------------------------------------
            //     // NOT_IMPLEMENTABLE: ModernAria: Not possible to unload modules + failing dependencies should not happen except for resources
