...
import { UtilsCallback } from '../utils/Callback.js';
     ...
     */
    export const MarkupWriter = classDefinition({
        ...
        $prototype : {
            ...
            repeater : function (repeaterParam) {
                this._beginSectionOrRepeater(repeaterParam, getClassRef('aria.templates.Repeater'));
                this.endSection();
            },
                            ...
                            var handler = function (event) {
                                ...
                                if (targetCallback) {
                                    if (event.type == "safetap") {
                                        getClassRef('aria.touch.ClickBuster')?.registerTap(event);
                                    }
            ...
            pushDelegate : function (eventName, callback) {
                ...
                callback = new UtilsCallback(callback);
