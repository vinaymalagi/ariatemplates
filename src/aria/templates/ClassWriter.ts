...
export class ClassWriter {
   ...
   */
  // TODO:ModernAria: Identify type for template param
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  public templateParam: any | null = null;
   ...
   * </pre>
   */
  // TODO:ModernAria: Type for widget libe record values
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  wlibs: { [key: string]: any } = {};
  ...
  addDependency(dependency: DependencySpec): void {
    ...
    if (!this._dependencies.has(dependency.libraryPath)) {
      this._dependencies.set(dependency.libraryPath, new Set<string>());
    }
    this._dependencies.get(dependency.libraryPath)?.add(dependency.importedItem);
  }
