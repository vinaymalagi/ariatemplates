 ...
 */
export class TplParser extends Parser {
   ...
   */
  public parseTemplate(template: string, context: {[key: string]: unknown}, _statements: string[], throwErrors: boolean): RootStatement | null {
