...
export const ClassGeneratorCfgSchema = z.object({
  parseOnly: z.boolean().describe("If true, the class will not be generated, but the template will be fully parsed, including all statement properties."),
