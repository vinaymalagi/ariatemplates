...
//     $singleton : false,
export class BaseCtxt {

  // ERROR MESSAGES:
  public static readonly TEMPLATE_CONSTR_ERROR = "Error while creating a new instance of template '%1' - please check script constructor.";
  public static readonly TEMPLATE_DESTR_ERROR = "Error while destroying an instance of template '%1' - please check script destructor.";
  public static readonly MACRO_NOT_FOUND = "Missing macro '%1' in template '%2'.";
  public static readonly MACRO_CALL_ERROR = "Error while calling macro '%1' in template '%2'.";
  public static readonly LIBRARY_HANDLE_CONFLICT = "Template error: can't load shared macro library '%1'. A macro, text template, variable or another library has already been declared with the same name.";
  public static readonly LIBRARY_ALREADY_LOADED = "Template error: library at classpath '%1' has already been loaded.";
   ...
   * @type Array
   *
   * TODO: ModernAria: Constrain type to Macrolib classes
   */
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  protected _macrolibs: any[] | null = [];
