...
import { ClassGeneratorCfg, ClassGeneratorCfgDefault, ClassGeneratorCfgSchema } from "./CfgBeans.js";
...
function normalizeOptions (optionsOrAllDeps: Partial<ClassGeneratorCfg> | boolean | unknown, context: Record<string, unknown>, debug: boolean, skipLogError: boolean): ClassGeneratorCfg {
...
export abstract class ClassGenerator {
  ...
  */
   ...
   */
  public parseTemplate(template: string, optionsOrAllDeps: object | boolean, callback: Callback, context: Record<string, unknown>, debug: boolean, skipLogError: boolean) {
   ...
   * @param {aria.core.CfgBeans:Callback} callback the callback description
   */
  private _buildClass(tree: RootStatement, options: ClassGeneratorCfg, callback: Callback) {
