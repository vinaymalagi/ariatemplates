...
export const CallbackSchema = z.object({
  fn: z.function().describe("Function to be called"),
  scope: z.any().optional().nullable().describe("Scope of execution of the function"),
  args: z.any().optional().describe("Optional argument passed to the function."),
  resIndex: z.number().optional().default(0).describe("Optional param to specify the index of the result or event object in the arguments passed to the callback function."),
  apply: z.boolean().default(false).describe("Whether we should use Function.call or Function.apply for args. Used only if args is an array"),
});
