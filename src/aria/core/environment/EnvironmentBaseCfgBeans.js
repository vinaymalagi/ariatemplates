 ...
 */
import { beanDefinitions } from '../bean-definitions.js';
import { FRAMEWORK_GLOBALS } from '../framework-bootstrap.js';
import { JsonTypesBeans } from '../JsonTypes.js';
 ...
 */
export const EnvironmentBaseCfgBeans = beanDefinitions({
    ...
    "AppSettingsCfg": {
      ...
      $properties: {
        ...
        "debug": {
          ...
          $default: FRAMEWORK_GLOBALS.debug
        },
        "waiAria": {
          $type: "json:Boolean",
