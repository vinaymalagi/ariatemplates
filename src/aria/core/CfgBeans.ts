...
export const CallbackSchema = z.object({
  ...
  resIndex: z.number().default(0).describe("Optional param to specify the index of the result or event object in the arguments passed to the callback function."),
