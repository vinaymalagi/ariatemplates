...
// TODO: Modern Aria: Import from Aria.ts
const disposeTag = 'aria:isDisposed';
...
abstract class JsObject {
  ...
  protected readonly $classpath: string = "aria.core.JsObject";

  /**
   * Tag to identify if current instance is disposed
   */
  public __isDisposed: boolean = false;

  // ERROR MESSAGES:
  public static readonly UNDECLARED_EVENT: string = "undeclared event name: %1";
  public static readonly MISSING_SCOPE: string = "scope property is mandatory when adding or removing a listener (event: %1)";
  public static readonly INTERFACE_NOT_SUPPORTED: string = "The '%1' interface is not supported on this object (of type '%2').";
  public static readonly ASSERT_FAILURE: string = "Assert #%1 failed in %2";
  public static readonly CALLBACK_ERROR: string = "An error occurred while processing a callback function: \ncalling class: %1\ncalled class: %2";
