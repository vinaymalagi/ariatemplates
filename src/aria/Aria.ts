...
export const version = 'ARIA-SNAPSHOT';
 ...
 * not equal in IE
 *
 * TODO:MODERN_ARIA: Re-evaluate this comment
 * TODO:MODERN_ARIA: Do we need this still?
...
/**
 * TODO:MODERN_ARIA:MemCheckMode: Figure out if Mem chekc mode is needed and how to implement
...
/**
 * TODO:MODERN_ARIA:ProfilingMode
...
/**
 * TODO:MODERN_ARIA:Domain: Config for IFrame support??
...
/**
 * TODO:MORDERN_ARIA:ClassDefinitionManagement: Maybe not needed, with es modules once loaded classes cannot be unloaded anyways
...
/**
 * TODO:MORDERN_ARIA:ClassDefinitionManagement: Get classref functionality needed?
 * Internal cache for getClassRef method
 * @see Aria.getClassRef()
 */
// var _getClassRefCache = {};
/**
 * TODO:MORDERN_ARIA:ClassDefinitionManagement: Get classref function needed?
...
/**
 * TODO:MORDERN_ARIA:ClassDefinitionManagement:Implement: Get instance for class might be useful
...
/**
 * TODO:MORDERN_ARIA:TPLScriptDefinition: To Implement as decorator??
...
// TODO:MORDERN_ARIA:DependencyManagement: How to implement?
