 ...
 */
export function getPropertyAccess(tagName, propertyName) {
  if (!Object.prototype.hasOwnProperty.call(__properties, propertyName)) {
    return "--";
  }
  var property = __properties[propertyName];
  if (typeof property == "object") {
    tagName = tagName.toUpperCase();
    if (!Object.prototype.hasOwnProperty.call(property, tagName)) {
      return "--";
    }
 ...
 */
export function isReadSafe(tagName, propertyName) {
  return getPropertyAccess(tagName, propertyName).charAt(0) == "r";
}
 ...
 */
export function isWriteSafe(tagName, propertyName) {
  return getPropertyAccess(tagName, propertyName).charAt(1) == "w";
}
