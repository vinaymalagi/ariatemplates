...
import * as cssPropertiesConfig from './PropertiesConfig.js';
...
export const CssUnits = classDefinition({
  ...
  $prototype: {
    ...
    __getStyleSimplified: function (element, property) {
      if (this.isIE8orLess) {
        ...
        return FRAMEWORK_GLOBALS.$window.getComputedStyle(element, "")[property] || element.style[property];
      }
    },
    ...
    getUnit: function (value, prop) {
      ...
      var unit = trim("" + value).toLowerCase().match(unitRegExp);
