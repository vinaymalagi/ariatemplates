 ...
 */
export function substitute(string) {
 ...
 */
export function indexOfNotEscaped(str, findChar, start) {
 ...
 */
export function escapeForHTML(str, options, infos) {
 ...
 */
export function stripAccents(stringToStrip) {
    var s = stringToStrip;
 ...
 */
export function nextWhiteSpace(str, start, end, regexp) {
 ...
 */
export function encodeForQuotedHTMLAttribute(str) {
 ...
 */
export function pad(string, size, character, begin) {
    string = "" + string;
 ...
 * Default false.
 */
export function crop(string, size, character, begin) {
    var start, length;
    if (begin === true) {
 ...
 * </pre>
 */
export function chunk(string, size, begin) {
    if (!isString(string)) {
        return null;
    } else if (!string) {
        return [string];
    ...
    if (isArray(size)) {
        return _chunkArray(string, size, begin);
    } else {
        return _chunkNumber(string, size, begin);
    }
}
 ...
 * @private
 */
function _chunkNumber(string, size, begin) {
 ...
 * @private
 */
function _chunkArray(string, size, begin) {
 ...
 */
export function wrap(string, wrapper) {
