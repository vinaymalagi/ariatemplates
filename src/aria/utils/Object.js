 ...
 */
export function forOwnKeys(object, callback, thisArg) {
  var index = 0;
 ...
 * If passend in object is not an Object, then returns empty array
 * @public
 * @param {Object} object
 * @return {Array}
 *
 * @deprecated use Object.keys directly, check whether the parameter is of type object first
 */
 ...
 * @private
 */
function _sourcesToTarget(object, callback, sources) {
  forEach(sources, function (source) {
    forOwnKeys(source, function (key) {
 ...
 */
export const assign = (Object.assign != null) ? function () {
  return Object.assign.apply(Object, arguments);
} : function (object) {
  var sources = Array.prototype.slice.call(arguments, 1);

  return _sourcesToTarget(object, function (object, source, key) {
