 ...
 */
export function ensureWrap(value) {
  if (!isArray(value)) {
    if (value == null) {
      value = [];
    } else {
 ...
 *
 * @deprecated use the Array.proptotype.indexOf directly
 */
// TODO: ModernAria: Check Usage, use the Array.proptotype.indexOf directly
 ...
 *
 * TODO: ModernAria: Maybe deprecate later and suggest use of array destruturing to clone. e.g. <code>clonedArray = [...array]</code>. Downside throws error for non-arrays and non-strings. slice will take all non-null, non-undefined values. e.g. Returns empty for numbers
 */
 ...
 */
export function repeatValue(item, times) {
  var result = [];
 ...
 * @return {Array} array
 *
 * @deprecated use the Array.proptotype.filter directly
 */
// TODO: ModernAria: Check Usage, use the Array.proptotype.filter directly
 ...
 * @param {Object} thisArg Object to use as this when executing callback.
 *
 * @deprecated use the Array.proptotype.forEach directly
 */
// TODO: ModernAria: Check Usage, use the Array.proptotype.forEach directly
export function forEach(array, callback, thisArg) {
 ...
 *
 * @deprecated use the Array.proptotype.map directly
 */
// TODO: ModernAria: Check Usage, use the Array.proptotype.map directly
 ...
 * @return {Array}
 */
export function extractValuesFromMap(map) {
  var output = [];
  for (var k in map) {
 ...
 *
 * @deprecated use the Array.proptotype.every directly
 */
// TODO: ModernAria: Check Usage, use the Array.proptotype.every directly
export function every(array, callback, thisArg) {
...
export function flattenDeep(value) {
  ...
  value.forEach(function (item) {
    pushAll(output, flattenDeep(item));
  });
 ...
 *
 * @deprecated use the Array.proptotype.reduce directly
 */
// TODO: ModernAria: Check Usage, use the Array.proptotype.reduce directly
...
export function insert(array, item, index) {
  ...
  if (index < array.length) {
    ...
    times(index - array.length, function () {
